...
// Get all courses (public - approved courses only for non-admin users)
...
// Approve/Disapprove course (Admin only)
...
router.get('/enrolled/my', authenticate, authorize('student'), async (req, res) => {
  try {
...
router.get('/instructor/my', authenticate, authorize('instructor'), async (req, res) => {
  try {
