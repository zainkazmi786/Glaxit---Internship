      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        <div className="h-screen flex pt-16 md:pt-20">
          ...
          <div className={`
            ...
            ${isSidebarOpen ? 'translate-x-0' : '-translate-x-[440px] mt-[25px] md:translate-x-0'}
            w-80 md:w-auto
          `}>
            <RoomList
          ...
          <div className="flex-1 flex flex-col backdrop-blur-sm bg-white/80 dark:bg-slate-800/80 border-l border-slate-200/50 dark:border-slate-700/50 md:border-l-0">
            {/* Mobile Room Header */}
            {currentRoom && (
              <div className="md:hidden flex items-center justify-between p-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-b border-slate-200/50 dark:border-slate-700/50">
