...
return (
    <div className="w-120  bg-gradient-to-b from-white to-slate-300 dark:from-slate-800/90 dark:to-slate-900/90 backdrop-blur-xl border-r border-slate-800/30 dark:border-slate-700/30 h-full flex flex-col shadow-2xl">
      {/* Header */}
