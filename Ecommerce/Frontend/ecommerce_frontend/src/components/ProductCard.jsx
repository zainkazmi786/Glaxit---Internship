...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      className="group rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 bg-white cursor-pointer"
    ...
    >
      <div className="relative overflow-hidden aspect-square flex items-center justify-center">
        ...
        />
        <div
          className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-indigo-600 to-indigo-500 text-white py-3 px-3 translate-y-full group-hover:translate-y-0 transition-transform duration-300"
      ...
      <div className="p-4" onClick={(e) => e.stopPropagation()}>
        ...
        <h3 className="font-medium text-gray-800 group-hover:text-indigo-600 transition mb-2 line-clamp-2 h-12">
          {product.title}
        </h3>
